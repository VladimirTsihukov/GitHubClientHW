...
import com.adnroidapp.githubclient.ui.MainActivity.Companion.KEY_USER_FRAGMENT
...
class UserFragment : MvpAppCompatFragment(R.layout.fragment_user), UserView, BackButtonListener {
    ...
    private val presenter by moxyPresenter {
        arguments?.getString(KEY_USER_FRAGMENT)?.let {
    ...
    companion object {
        fun newInstance(nameUser: String): UserFragment {
            val bundle = Bundle()
            bundle.putString(KEY_USER_FRAGMENT, nameUser)
